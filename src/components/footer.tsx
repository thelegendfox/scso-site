  ...
  return (
    <div className="bg-black mb-4 px-8 h-40 w-full flex flex-col">
      ...
      <p className="text-xs text-zinc-400 text-center">
        The Sarasota County Sheriff's Office, Siesta Key Roleplay, Central
        Roleplay Community (and Maple County), as well as all other copyrighted
        symbols used on this page are copyrighted by their respective
        organizations, companies, agencies, etc. No ownership is claimed over
        these and these symbols are used under either permissable circumstances,
        Fair Use, or are part of the Public Domain. No agencies mentioned have
        had any part in the development of this site.
      </p>
    </div>
  );
}
